    ...
    <div class="row">
        <div class="col-md-12">
            <div class="row">
                ...
                <?php ?>
                <div class="col-xs-4">
                    <a href="<?php echo ${$p}[$a]; ?>"><img src="<?php echo get_template_directory_uri() ;?>/bootstrap/img/partenaires/<?php echo $p; ?>/<?php echo $NbTires[1]; ?>.jpg" class="img-responsive" alt="<?php echo $alt[${$p}[$a]]; ?>"/></a>
                </div>
                <div class="col-xs-4">
                    <a href="<?php echo ${$p}[$b]; ?>"><img src="<?php echo get_template_directory_uri() ;?>/bootstrap/img/partenaires/<?php echo $p; ?>/<?php echo $NbTires[2]; ?>.jpg" class="img-responsive" alt="<?php echo $alt[${$p}[$b]]; ?>"/></a>
                </div>
                <div class="col-xs-4">
                    <a href="<?php echo ${$p}[$c]; ?>"><img src="<?php echo get_template_directory_uri() ;?>/bootstrap/img/partenaires/<?php echo $p; ?>/<?php echo $NbTires[3]; ?>.jpg" class="img-responsive" alt="<?php echo $alt[${$p}[$c]]; ?>"/></a>
                </div>
                <?php
                ?>
            </div>
